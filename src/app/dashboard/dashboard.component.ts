...
export class DashboardComponent implements OnInit {
  ...
  /**
   * Método chamado assim que a API de gráficos é inicializada. Responsável por chamar os métodos gerado-
   * res dos grádicos.
   * @returns void
   */
  exibirGraficos(): void {
  ...
  /**
   * Exibe o gráficp Pie Chart em 3D.
   * @returns void
   */
  ...
  /**
   * Cria e retorna o objeto DataTable da API de gráficos, responsável por definir os dados dos gráfico.
   * @returns any
   */
  obterDataTable(): any {
